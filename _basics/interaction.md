...
Check out the [DisplayObject documentation]({{ site.data.links.api-displayobject }}) for the list of interaction events supported.
...
Once you've set up your interaction objects, it can be useful to test what object is under a given point.  You can use [PIXI.InteractionManager]({{ site.data.links.api-interactionmanager }})'s `hitTest()` method to find the interactive object at a (global) point:
